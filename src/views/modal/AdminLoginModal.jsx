...
import { BsCheckCircle, BsExclamationCircle } from "react-icons/bs"; // Import the icons

const AdminLoginModal = ({ show, handleClose, message, isAdmin }) => {
  ...
  return (
    ...
    >
      ...
      <Modal.Footer
        ...
        style={styles.modalContent}
      >
        <Button className="border-0" style={styles.modalHeader} variant="secondary" onClick={handleClose}>
          Close
        </Button>
      </Modal.Footer>
    </Modal>
